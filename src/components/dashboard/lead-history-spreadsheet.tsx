    ...
    <Card className="hover:shadow-md transition-shadow">
      <CardContent className="p-4">
        <div className="space-y-3">
          ...
          {/* Verification status for managers - Updated to use proper props */}
          <div className="flex items-center justify-between">
            <VerifiedCheckbox leadId={lead.id} isVerified={lead.setterVerified || false} />
...
export default function LeadHistorySpreadsheet() {
